...
$(document).ready(function () {
    ...
    explodeSound = [new Audio("picAndSound/explode.mp3"), new Audio("picAndSound/explode.mp3"), new Audio("picAndSound/explode.mp3"), new Audio("picAndSound/explode.mp3"), new Audio("picAndSound/explode.mp3")]; // מערך של סאונדים של פיצוצים בשביל מצבים בהם כמה אסטרואידים מתפוצצים בו זמנית
    explodeSoundIndex = 0; // אינדקס למערך של הסאונדים לפיצוצים
    fireSound = [new Audio("picAndSound/fire.mp3"), new Audio("picAndSound/fire.mp3"), new Audio("picAndSound/fire.mp3"), new Audio("picAndSound/fire.mp3"), new Audio("picAndSound/fire.mp3")]; // מערך של סאונדים של יריות בשביל מצבים בהם כמה יריות יושמעו בו זמנית
